...
| close_approach_data[0].miss_distance.lunar                   | miss_distance_lunar        | number              |           |
...
| Source field                                          | Reason                                                                       |
| ----------------------------------------------------- | ---------------------------------------------------------------------------- | 
| absolute_magnitude_h                                  | Redundant — estimated_diameter_max_km provides a more intuitive size measure |
